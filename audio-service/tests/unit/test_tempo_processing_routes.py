...
class TestTempoProcessingRoutes:
    ...
    def test_celery_task_import_conflict_prevention(self):
        ...
        assert hasattr(
            tempo_tasks.process_tempo_from_storage, "delay"
        ...
        assert hasattr(
            tempo_routes.process_tempo_from_storage, "delay"
        ...
        assert (
            route_func is not None
        ), "Route function should be named process_tempo_from_storage_route"
    ...
    def test_storage_tempo_processing_calls_correct_task(
        self, mock_task, mock_storage_service, mock_storage_enabled
    ):
        """
    ...
    def test_storage_disabled_error(self, mock_storage_enabled):
        ...
        request_data = {"storage_path": "uploads/test/file.mp3", "preset": "nightcore"}
...
class TestCeleryTaskAvailability:
    ...
    def test_tempo_tasks_have_delay_method(self):
        ...
        assert hasattr(
            process_tempo_from_storage, "delay"
    ...
    def test_celery_task_names(self):
        ...
        # Check task names
        assert (
            process_tempo_from_storage.name
...
class TestTempoTaskImports:
    ...
    def test_performance_cache_imports_available(self):
        ...
        assert callable(tempo_tasks.audio_hash), "audio_hash should be callable"
