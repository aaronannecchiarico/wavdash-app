...
class TestAnalysisSummary:
    ...
    def test_analysis_summary_single_chunk(self):
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
             ...
             patch('tasks.storage_processing.create_feature_extractor') as mock_extractor, \
            ...
            mock_storage.upload_analysis_result.return_value = "processed/1/2025/08/13/test_features.json"
            ...
            assert result['storage_analysis_path'] == "processed/1/2025/08/13/test_features.json"
    ...
    def test_analysis_summary_multi_chunk(self):
        ...
        mock_feature_result = {
            ...
            'aggregated_features': {
                ...
                'key': {'most_likely_key': 'A minor', 'confidence': 0.75, 'key_changes': 2},
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
            ...
            mock_storage.file_exists.return_value = True
            mock_storage.download_file.return_value = True
            mock_storage.upload_analysis_result.return_value = "processed/2/2025/08/13/long_features.json"
            ...
            # Verify storage path includes user_id
            assert result['storage_analysis_path'] == "processed/2/2025/08/13/long_features.json"
    ...
    def test_analysis_summary_missing_features(self):
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
            ...
            mock_storage.file_exists.return_value = True
            mock_storage.download_file.return_value = True
            mock_storage.upload_analysis_result.return_value = "processed/3/2025/08/13/partial_features.json"
    ...
    def test_analysis_summary_no_features(self):
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
            ...
            mock_storage.file_exists.return_value = True
            mock_storage.download_file.return_value = True
            mock_storage.upload_analysis_result.return_value = "processed/4/2025/08/13/error_features.json"
    ...
    def test_user_id_in_storage_path(self):
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
            ...
            test_cases = [
                {"user_id": "1", "expected_path": "processed/1/2025/08/13/test_features.json"},
                {"user_id": "42", "expected_path": "processed/42/2025/08/13/test_features.json"},
                {"user_id": "999", "expected_path": "processed/999/2025/08/13/test_features.json"},
            ]
            ...
            for case in test_cases:
                ...
                assert call_args[0][3] == case['user_id']  # 4th argument should be user_id
    ...
    def test_analysis_summary_without_user_id(self):
        ...
        with patch('tasks.storage_processing.get_storage_service') as mock_storage_service, \
            ...
            mock_storage.file_exists.return_value = True
            mock_storage.download_file.return_value = True
            mock_storage.upload_analysis_result.return_value = "processed/2025/08/13/no_user_features.json"
            ...
            assert result['storage_analysis_path'] == "processed/2025/08/13/no_user_features.json"
