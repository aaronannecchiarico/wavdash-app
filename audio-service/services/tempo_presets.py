...
class TempoPresetsService:
    ...
    def _load_default_presets(self) -> Dict[TempoPresetEnum, TempoPresetConfig]:
        ...
        return {
            ...
            TempoPresetEnum.CHOPPED_SCREWED: TempoPresetConfig(
                ...
                filter_settings={"cutoff_hz": 5000.0, "resonance": 0.7},
            ),
    ...
    def apply_preset_to_params(
        ...
        final_tempo_factor = (
            preset.tempo_factor if tempo_factor == 1.0 else tempo_factor
        )
        final_pitch_shift = (
        ...
        final_preserve_pitch = (
            preset.preserve_pitch if not preserve_pitch else preserve_pitch
        )
