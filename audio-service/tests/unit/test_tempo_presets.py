...
class TestTempoPresetsService:
    ...
    def test_calculate_final_bpm_time_stretched(self):
        ...
        final_bpm = self.service.calculate_final_bpm(120.0, TempoPresetEnum.TIME_STRETCHED)
    ...
    def test_get_preset_description(self):
        ...
        description = self.service.get_preset_description(TempoPresetEnum.CHOPPED_SCREWED)
        assert "Houston hip-hop" in description
        
        description = self.service.get_preset_description(TempoPresetEnum.TIME_STRETCHED)
