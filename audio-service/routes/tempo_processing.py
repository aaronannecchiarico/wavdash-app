...
async def get_tempo_presets():
    ...
    for preset_key, preset_info in all_presets.items():
        try:
            ...
            preset_info["description"] = presets_service.get_preset_description(preset_enum)
        except ValueError:
...
async def check_system_compatibility():
    ...
    try:
        ...
        return {
            ...
            "phase": "Phase 2: Enhanced pedalboard processing available" if compatibility_info["pedalboard_available"] else "Phase 1: Basic librosa processing"
        }
    except Exception as e:
    ...
    try:
        ...
        return {
            ...
            "audio_analysis": {
                ...
                "classification": "fast" if current_bpm > 140 else "slow" if current_bpm < 80 else "moderate"
            },
...
async def get_performance_metrics():
    ...
    """
    try:
        from services.performance_cache import get_performance_monitor, get_performance_cache
        ...
        return {
            ...
            "recommendations": _generate_performance_recommendations(performance_summary, cache_stats)
        }
...
def _generate_performance_recommendations(performance_summary: dict, cache_stats: dict) -> list:
