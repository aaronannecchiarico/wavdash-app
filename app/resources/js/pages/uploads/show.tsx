...
export default function Show({ upload }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-4 py-8 sm:px-6 lg:pr-8 lg:pl-6">
                <div className="space-y-8">
                    {/* Upload header with color block */}
                    <section
                        className="border-2 border-border bg-chart-2 p-8 transition-all hover:translate-x-1 hover:translate-y-1"
                        style={{ boxShadow: 'var(--shadow)' }}
                    >
                        <div className="flex items-start justify-between">
                            <div>
                                <h1 className="mb-2 font-heading text-3xl font-black tracking-wider text-main-foreground uppercase">
                                    {uploadData.title}
                                </h1>
                            ...
                            <Badge className={`${getStatusColorNeo(uploadData.status)} font-heading font-black tracking-wider uppercase`}>
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-5 lg:gap-16">
                        ...
                        <div className="lg:col-span-3 lg:pr-8">
                            <Card className="transition-all hover:translate-x-1 hover:translate-y-1">
                                <CardHeader className="bg-secondary-background">
                                    <CardTitle className="font-heading font-black tracking-wider text-main-foreground uppercase">
                                        TRACK DETAILS
                                    </CardTitle>
                                </CardHeader>
                                ...
                                <CardContent className="space-y-6">
                                    {uploadData.description && (
                                        <div className="border-2 border-border bg-background p-4">
                                            <h3 className="mb-2 font-heading text-sm font-black tracking-wider text-foreground uppercase">
                                                DESCRIPTION
                                            </h3>
                                    ...
                                    <div className="border-2 border-border bg-background p-4">
                                        <h3 className="mb-4 font-heading text-sm font-black tracking-wider text-foreground uppercase">
                                            FILE DETAILS
                                        </h3>
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                            <div className="border-2 border-border bg-chart-1 p-3">
                                                <dt className="font-heading text-xs font-black text-main-foreground uppercase">FILENAME</dt>
                                            ...
                                            <div className="border-2 border-border bg-chart-2 p-3">
                                                <dt className="font-heading text-xs font-black text-main-foreground uppercase">TYPE</dt>
                                            ...
                                            <div className="border-2 border-border bg-chart-3 p-3">
                                                <dt className="font-heading text-xs font-black text-main-foreground uppercase">SIZE</dt>
                                            ...
                                            <div className="border-2 border-border bg-chart-4 p-3">
                                                <dt className="font-heading text-xs font-black text-main-foreground uppercase">LAST UPDATED</dt>
                                    ...
                                    {uploadData.status === 'ready' && uploadData.stream_url && (
                                        <div className="border-2 border-border bg-background p-4">
                                            ...
                                            <AudioPlayer url={uploadData.stream_url} title="MAIN TRACK" className="mb-4" />
                                        </div>
                                    )}
                                </CardContent>

                                <CardFooter className="flex flex-wrap justify-between gap-4 border-t-2 border-border bg-border">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            className="bg-red-500 font-heading font-black tracking-wider text-white uppercase hover:bg-red-600"
                        ...
                        <div className="lg:col-span-2 lg:pl-8">
                            <div
                                className="border-2 border-border bg-background p-6 transition-all hover:translate-x-1 hover:translate-y-1"
                                style={{ boxShadow: 'var(--shadow)' }}
                            >
                                <h2 className="mb-6 font-heading text-2xl font-black tracking-wide text-foreground uppercase">PROCESSING OPTIONS</h2>
